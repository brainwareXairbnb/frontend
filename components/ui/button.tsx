...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-on-surface text-surface hover:bg-primary transition-all active:scale-95 font-black text-sm tracking-[0.2em] shadow-[0_20px_40px_-10px_rgba(0,0,0,0.15)]',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'bg-white border-2 border-outline-variant/5 text-on-surface hover:bg-[#FAFAFA] hover:border-primary/20 transition-all active:scale-[0.98] font-black text-sm tracking-widest',
        secondary:
