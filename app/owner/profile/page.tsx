...
export default function OwnerProfilePage() {
  ...
  const mobilePrimaryItems: MenuItem[] = [
    { id: 'security', label: 'Login & security', icon: Lock, path: '/owner/profile/security' },
    { id: 'payments', label: 'Payout methods', icon: CreditCard, path: '/owner/profile/payments' },
  ]
  ...
  const desktopPrimaryItems: MenuItem[] = [
    ...
    },
    {
      ...
      description: 'Manage your payout methods and billing settings',
      icon: CreditCard,
      ...
      <div className='md:hidden min-h-screen' style={{ background: '#fff' }}>
        ...
        <div className='max-w-lg mx-auto px-5 pt-6 pb-24'>
          ...
          <div className='relative flex items-center gap-4 mb-8'>
            ...
            {/* Edit icon */}
            <button
              onClick={() => router.push('/owner/profile/personal-info')}
