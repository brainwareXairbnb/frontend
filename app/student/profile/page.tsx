  ...
  return (
    <div className='bg-white min-h-screen'>
      <header className='p-8 md:px-10'>
        {!user && (
          <h1 className='text-[32px] font-bold text-on-surface mb-2 md:pt-4'>
            Profile
          </h1>
        )}
        ...
        {!user ? (
          ...
          <div className='flex items-center gap-5 group cursor-pointer border-b border-outline-variant/10 pb-8 max-w-2xl'>
            ...
            <div className='flex-1'>
              ...
              <p className='text-sm text-on-surface-variant group-hover:underline'>
                Show profile
              </p>
            </div>
              ...
              {[
                ...
                >
                  <div className='flex items-center gap-4'>
                    ...
                    <span className='text-[17px] text-on-surface font-medium'>
                      {item.l}
                    </span>
                  </div>
