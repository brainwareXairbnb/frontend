  ...
  return (
    <div className='flex min-h-screen bg-[#fafafa] flex-col'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div className='w-10 h-10 rounded-full overflow-hidden bg-primary'>
              <img
                ...
                src='https://ui-avatars.com/api/?name=Admin+User&background=b6212f&color=fff&size=128'
              />
            </div>
          </div>
        </div>
      ...
      <div className='flex flex-1'>
        ...
        {/* Main Content */}
        <div className='flex-1 overflow-y-auto bg-[#fafafa] md:ml-64'>{children}</div>
      </div>
