...
export default function BecomeHostPage() {
  ...
  const checkUpgradeStatus = async () => {
    try {
      ...
      if (status.hasUpgradeRequest && status.upgradeRequest.status === 'pending') {
        setSuccess(true)
      }
    } catch (err) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Registry Active', { description: 'Owner node upgrade synchronized' })
      setSuccess(true)
      window.scrollTo({ top: 0, behavior: 'smooth' })
    } catch (err: any) {
      toast.error('Registry Failed', { description: err.message || 'Failed to submit request' })
    } finally {
    ...
    return (
      <div className="min-h-screen bg-white pt-32 px-6">
        <div className="max-w-2xl mx-auto text-center space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <h1 className="text-3xl font-bold text-on-surface">Application Submitted!</h1>
          <p className="text-on-surface-variant text-lg leading-relaxed">
            Your request to become a property owner is currently being reviewed by our administrative team.
          ...
          <div className="bg-surface-container rounded-2xl p-6 text-left border border-outline-variant/20">
            ...
            <ul className="space-y-3 text-sm text-on-surface-variant">
              ...
              <li>• After approval, you can start listing your properties immediately.</li>
            </ul>
          </div>
          <button
            onClick={() => router.push('/')}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="max-w-2xl space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              Ready to host <span className="text-[#FF385C]">student</span> rooms?
            </h1>
            <p className="text-xl text-white/70">
              Join thousands of owners nearby Brainware University and help students find their perfect home.
            </p>
          </div>
        </div>
        {/* Abstract shapes */}
              ...
              <form onSubmit={handleSubmit} className="space-y-6 md:space-y-10">
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-on-surface-variant ml-1">NID / Aadhaar Number</label>
                      <input
                        required
                        name="nidNo"
                        type="text"
                    ...
                    <div className="md:col-span-2 space-y-2">
                      <label className="text-sm font-bold text-on-surface-variant ml-1">Business Address</label>
                      <textarea
                        required
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-on-surface-variant ml-1">Account Holder Name</label>
                      <input
                        required
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-on-surface-variant ml-1">Bank Name</label>
                      <input
                        required
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-on-surface-variant ml-1">Account Number</label>
                      <input
                        required
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-on-surface-variant ml-1">IFSC Code</label>
                      <input
                        required
                ...
                <p className="text-center text-xs text-on-surface-variant leading-relaxed px-10">
                  By submitting, you agree to the Brainware Rooms Owner Terms of Service and Payout Policy.
          ...
          <div className="space-y-6">
            <div className="bg-surface-container/50 rounded-3xl p-8 border border-outline-variant/10 space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-on-surface-variant leading-relaxed">Connect directly with verified students from Brainware University.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-on-surface-variant leading-relaxed">Join a network of trusted local property owners.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-on-surface-variant leading-relaxed">Automated monthly rent collection straight to your bank.</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 bg-[#FF385C]/5 rounded-3xl border border-[#FF385C]/10">
              <p className="text-sm text-[#FF385C] font-semibold italic leading-relaxed">
                "I listed my flat on Brainware Rooms and found 3 great student tenants within a week. The verification process gives me peace of mind."
              </p>
